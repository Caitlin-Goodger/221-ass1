...
public class Move implements Operation {
	...
	public static boolean nextTo(Location l1, Location l2) {
		//Changed return statement to properly check if locations are next to each other 
		return (l1.row == l2.row && (l1.col -l2.col == 1 || l1.col -l2.col == -1 )) || (l1.col == l2.col && (l1.row -l2.row == 1 || l1.row -l2.row == -1 )); 
	}
}
